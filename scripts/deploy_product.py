...
CHAIN_ID_MUMBAI = 80001 # arbitrum one - 42161
...
REQUIRED_FUNDS_S = int(GAS_PRICE * GAS_PRICE_SAFETY_FACTOR * GAS_S) # 0.004 eth
REQUIRED_FUNDS_M = int(GAS_PRICE * GAS_PRICE_SAFETY_FACTOR * GAS_M) # 0.012 eth
REQUIRED_FUNDS_L = int(GAS_PRICE * GAS_PRICE_SAFETY_FACTOR * GAS_L) # 0.04 eth
...
def all_in_1_base(
    ...
    a = stakeholders_accounts or stakeholders_accounts_ganache() # returns 10 ganache accounts

    # assess balances at beginning of deploy
    balances_before = _get_balances(a) # returns dic of account-> balance
    ...
    # In this case the file gif_instance_address.txt needs to exist 
    # and contain the addresses of the instance registry 
